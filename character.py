...
class Alagoano(pygame.sprite.Sprite):
    ...
    def down(self):
        if (855 > self.rect.x > 300 and 300 > self.rect.y > 290):
            ...
            self.lock = 0
            return 0
        elif 105 > self.rect.x > 25 and 293 < self.rect.y < 300:
            self.jumpi = 0
            self.lock = 0
            return 0
        elif 205 > self.rect.x > 125 and 220 < self.rect.y < 240:
            self.jumpi = 0
            self.lock = 0
            return 0
            ...
            self.lock = 0
            return 0
        elif 115 > self.rect.x > 39 and 300 < self.rect.y < 304:
            self.jumpi = 0
            self.lock = 0
            return 0
            ...
            self.lock = 0
            return 0
        elif 755 > self.rect.x > 695 and 130 < self.rect.y < 140:
            self.jumpi = 0
            self.lock = 0
            return 0
